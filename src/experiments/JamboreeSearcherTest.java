...
public class JamboreeSearcherTest<M extends Move<M>, B extends Board<M, B>> extends
	...
	public static LongAdder JamboreeCount = new LongAdder();
	...
	public class GetBestMoveTask extends RecursiveTask<BestMove<M>> {
	    ...
	    public BestMove<M> compute() {
    		...
    		if (depth <= sequentialCutOff || moves.isEmpty()) {
    			return AlphaBetaSearcherTest.alphaBeta(evaluator, board, depth, alpha, beta);
    		}
